...
const seoPages: SeoPage[] = [
  // Hospital x situation pages
  {
    ...
    metaTitle: "HCA Healthcare Charity Care & Financial Assistance | BillDelete",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle:
      "Ascension Hospital Financial Assistance Program | BillDelete",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle:
      "CommonSpirit Health Charity Care Application Guide | BillDelete",
    metaDescription:
    ...
    paragraphs: [
      ...
      "CommonSpirit hospitals provided $1.8 billion in charity care in 2023. If you received care at a CommonSpirit facility and are struggling with the bill, you may be leaving money on the table by not applying. BillDelete generates a customized financial hardship letter that references CommonSpirit's specific obligations under IRS 501(r).",
    ],
  },
  {
    slug: "providence-financial-assistance",
    h1: "Providence Hospital Financial Assistance: Generous Charity Care",
    metaTitle: "Providence Hospital Financial Assistance Guide | BillDelete",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle:
      "Kaiser Permanente Medical Financial Assistance | BillDelete",
    metaDescription:
    ...
    paragraphs: [
      ...
      "Kaiser's 350% FPL threshold means that a single person earning under roughly $54,775 or a family of four under approximately $113,400 could qualify for free care. BillDelete helps you prepare a compelling financial assistance application that maximizes your chances of approval.",
    ],
  },
  // Procedure x situation pages
  {
    ...
    metaTitle: "How to Negotiate an ER Bill & Save 40-70% | BillDelete",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "How to Negotiate MRI Costs & Save Thousands | BillDelete",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle:
      "How to Negotiate Surgery Costs & Reduce Your Bill | BillDelete",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle:
      "How to Negotiate Childbirth & Delivery Costs | BillDelete",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "How to Negotiate a CT Scan Bill | BillDelete",
    metaDescription:
  ...
  // State pages
  {
    ...
    metaTitle:
      "Negotiate Medical Bills in California: Laws & Rights | BillDelete",
    metaDescription:
    ...
    paragraphs: [
      ...
      "If you are fighting a medical bill in California, you have particularly strong legal backing. BillDelete generates negotiation letters that cite California-specific statutes and regulations in addition to federal protections, giving your negotiation extra weight with California hospitals.",
    ],
  },
  {
    ...
    metaTitle:
      "Texas Hospital Charity Care & Financial Assistance | BillDelete",
    metaDescription:
    ...
    paragraphs: [
      ...
      "If you received care at a Texas hospital, check the hospital's nonprofit status and apply for financial assistance if your income qualifies. BillDelete creates customized financial assistance applications that reference the specific policies of major Texas hospital systems.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in New York: Laws & Protections | BillDelete",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in Florida: Laws & Options | BillDelete",
    metaDescription:
    ...
    paragraphs: [
      ...
      "BillDelete generates documents customized for Florida patients, referencing both federal protections and Florida-specific statutes. Whether you are negotiating with AdventHealth, HCA, or any other Florida hospital system, our letters provide data-driven arguments for reducing your bill.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in Illinois: Laws & Resources | BillDelete",
    metaDescription:
    ...
    paragraphs: [
      ...
      "If you are dealing with a medical bill in Illinois, the combination of strong state protections and generous hospital financial assistance programs means you have significant leverage. BillDelete creates documents that reference Illinois-specific requirements to strengthen your negotiation.",
    ],
  },
  {
    ...
    metaTitle:
      "Negotiate Medical Bills in Washington State | BillDelete",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "Fight Medical Bills in Ohio: Rights & Resources | BillDelete",
    metaDescription:
    ...
    paragraphs: [
      ...
      "If you are facing a medical bill from an Ohio hospital, request an itemized statement, apply for financial assistance at nonprofit facilities, and consider negotiating your remaining balance. BillDelete creates documents tailored to Ohio hospital systems and their specific charity care policies.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in Pennsylvania: Your Guide | BillDelete",
    metaDescription:
    ...
    paragraphs: [
      ...
      "If you received care at a Pennsylvania hospital, check the facility's nonprofit status and apply for financial assistance if eligible. BillDelete generates customized documents that reference the specific policies of UPMC, Geisinger, and other Pennsylvania hospital systems.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in Michigan: Laws & Assistance | BillDelete",
    metaDescription:
    ...
    paragraphs: [
      ...
      "BillDelete creates negotiation letters and financial assistance applications tailored to Michigan hospital systems. Whether your bill is from Trinity Health, a University of Michigan facility, or another Michigan provider, our documents reference applicable policies and Medicare rate benchmarks.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in North Carolina | BillDelete",
    metaDescription:
    ...
    paragraphs: [
      ...
      "BillDelete generates documents specifically tailored to North Carolina hospitals, referencing Atrium Health and Novant Health charity care policies alongside federal 501(r) requirements and Medicare rate comparisons for your specific procedures.",
    ],
  },
  {
    slug: "negotiate-colonoscopy-bill",
    h1: "How to Negotiate a Colonoscopy Bill",
    metaTitle: "How to Negotiate Colonoscopy Costs | BillDelete",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "How to Negotiate an Ambulance Bill | BillDelete",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "How to Negotiate Physical Therapy Bills | BillDelete",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "How to Negotiate Dental Implant Costs | BillDelete",
    metaDescription:
    ...
    paragraphs: [
      ...
      "Many dental offices offer 10-20% cash-pay discounts for patients who pay upfront. If you are financing the procedure, compare the dental office's in-house financing terms against a personal loan or medical credit card to find the lowest total cost. BillDelete generates negotiation letters tailored to dental billing practices.",
    ],
  },
  {
    slug: "medical-bills-georgia",
    h1: "Fighting Medical Bills in Georgia",
    metaTitle: "Fight Medical Bills in Georgia: Rights & Options | BillDelete",
    metaDescription:
    ...
    paragraphs: [
      ...
      "If you are fighting a medical bill in Georgia, start by checking whether your hospital is nonprofit and applying for financial assistance. BillDelete generates documents that reference Georgia-specific billing practices and the charity care policies of major Georgia hospital systems.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in Arizona: Your Options | BillDelete",
    metaDescription:
    ...
    paragraphs: [
      ...
      "BillDelete generates negotiation letters and financial assistance applications customized for Arizona hospitals, including Banner Health facilities. Our documents reference Medicare rates for the Phoenix and Tucson geographic payment areas and cite applicable federal protections.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in Colorado: Laws & Programs | BillDelete",
    metaDescription:
    ...
    paragraphs: [
      ...
      "If you are dealing with a medical bill in Colorado, you benefit from both strong state protections and the federal safety net. BillDelete creates documents that cite Colorado's Hospital Discounted Care program and UCHealth-specific policies alongside Medicare rate comparisons.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in Massachusetts: Complete Guide | BillDelete",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in Minnesota: Rights & Resources | BillDelete",
    metaDescription:
    ...
    paragraphs: [
      ...
      "Whether your bill is from the Mayo Clinic, a regional hospital, or a community clinic, BillDelete generates customized negotiation letters that cite Medicare rates specific to Minnesota's geographic payment areas and reference applicable charity care policies.",
    ],
  },
  {
    slug: "medical-bills-louisiana",
    h1: "Fighting Medical Bills in Louisiana",
    metaTitle: "Fight Medical Bills in Louisiana | BillDelete",
    metaDescription:
    ...
    paragraphs: [
      ...
      "BillDelete generates negotiation letters and financial assistance applications specifically for Louisiana patients. Our documents reference Ochsner Health and other Louisiana hospital system policies, cite Medicare rates for Louisiana geographic areas, and leverage applicable state and federal protections.",
    ],
  },
  {
    ...
    metaTitle:
      "How to Negotiate Knee Replacement Costs | BillDelete",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "How to Negotiate Lab Work Costs | BillDelete",
    metaDescription:
...
export async function generateMetadata({
  ...
  if (!page) return { title: "BillDelete" }
  return {
