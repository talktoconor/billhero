...
const seoPages: SeoPage[] = [
  // Hospital x situation pages
  {
    ...
    metaTitle: "HCA Healthcare Charity Care & Financial Assistance | UnBill",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle:
      "Ascension Hospital Financial Assistance Program | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "If your Ascension bill is higher than expected, start by requesting a detailed itemized bill. Then check your eligibility for financial assistance and negotiate any remaining balance. UnBill creates professionally formatted applications and negotiation letters tailored to Ascension's specific policies.",
    ],
  },
  {
    ...
    metaTitle:
      "CommonSpirit Health Charity Care Application Guide | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "CommonSpirit hospitals provided $1.8 billion in charity care in 2023. If you received care at a CommonSpirit facility and are struggling with the bill, you may be leaving money on the table by not applying. UnBill generates a customized financial hardship letter that references CommonSpirit's specific obligations under IRS 501(r).",
    ],
  },
  {
    slug: "providence-financial-assistance",
    h1: "Providence Hospital Financial Assistance: Generous Charity Care",
    metaTitle: "Providence Hospital Financial Assistance Guide | UnBill",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle:
      "Kaiser Permanente Medical Financial Assistance | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "Kaiser's 350% FPL threshold means that a single person earning under roughly $54,775 or a family of four under approximately $113,400 could qualify for free care. UnBill helps you prepare a compelling financial assistance application that maximizes your chances of approval.",
    ],
  },
  // Procedure x situation pages
  {
    ...
    metaTitle: "How to Negotiate an ER Bill & Save 40-70% | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "A formal negotiation letter citing Medicare rates and fair market prices carries significantly more weight than a phone call. UnBill generates customized ER bill negotiation letters that reference the specific CPT codes on your bill, Medicare reimbursement rates, and applicable legal protections.",
    ],
  },
  {
    slug: "negotiate-mri-cost",
    h1: "How to Negotiate the Cost of an MRI",
    metaTitle: "How to Negotiate MRI Costs & Save Thousands | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "For future MRIs, consider getting the scan at a freestanding imaging center. The quality is identical, but the price is typically 50-70% lower. UnBill negotiation letters include Medicare rate comparisons and fair market pricing data specific to your MRI procedure code.",
    ],
  },
  {
    ...
    metaTitle:
      "How to Negotiate Surgery Costs & Reduce Your Bill | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "If the surgery was performed at an outpatient surgery center, the total cost should be 30-50% less than a hospital-based procedure. Verify that you are being charged outpatient rates if appropriate. UnBill generates surgery-specific negotiation letters that address each billing component individually.",
    ],
  },
  {
    ...
    metaTitle:
      "How to Negotiate Childbirth & Delivery Costs | UnBill",
    metaDescription:
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "UnBill negotiation letters reference the specific CPT codes used for your CT scan and compare your charges against both Medicare rates and fair market prices for your geographic area. This data-driven approach is far more effective than simply asking for a discount.",
    ],
  },
  // State pages
  {
    ...
    metaTitle:
      "Negotiate Medical Bills in California: Laws & Rights | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "If you are fighting a medical bill in California, you have particularly strong legal backing. UnBill generates negotiation letters that cite California-specific statutes and regulations in addition to federal protections, giving your negotiation extra weight with California hospitals.",
    ],
  },
  {
    ...
    metaTitle:
      "Texas Hospital Charity Care & Financial Assistance | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "If you received care at a Texas hospital, check the hospital's nonprofit status and apply for financial assistance if your income qualifies. UnBill creates customized financial assistance applications that reference the specific policies of major Texas hospital systems.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in New York: Laws & Protections | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "Whether you are dealing with a bill from a New York City hospital or a facility upstate, UnBill generates negotiation and financial assistance documents that cite New York-specific statutes and the hospital's particular charity care policies for maximum impact.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in Florida: Laws & Options | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "UnBill generates documents customized for Florida patients, referencing both federal protections and Florida-specific statutes. Whether you are negotiating with AdventHealth, HCA, or any other Florida hospital system, our letters provide data-driven arguments for reducing your bill.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in Illinois: Laws & Resources | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "If you are dealing with a medical bill in Illinois, the combination of strong state protections and generous hospital financial assistance programs means you have significant leverage. UnBill creates documents that reference Illinois-specific requirements to strengthen your negotiation.",
    ],
  },
  {
    ...
    metaTitle:
      "Negotiate Medical Bills in Washington State | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "UnBill generates financial assistance applications and negotiation letters that specifically cite Washington's charity care statutes, which provide stronger protections than federal law alone. This state-specific approach gives Washington patients particularly strong leverage.",
    ],
  },
  {
    slug: "medical-bills-ohio",
    h1: "Fighting Medical Bills in Ohio: Your Options",
    metaTitle: "Fight Medical Bills in Ohio: Rights & Resources | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "If you are facing a medical bill from an Ohio hospital, request an itemized statement, apply for financial assistance at nonprofit facilities, and consider negotiating your remaining balance. UnBill creates documents tailored to Ohio hospital systems and their specific charity care policies.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in Pennsylvania: Your Guide | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "If you received care at a Pennsylvania hospital, check the facility's nonprofit status and apply for financial assistance if eligible. UnBill generates customized documents that reference the specific policies of UPMC, Geisinger, and other Pennsylvania hospital systems.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in Michigan: Laws & Assistance | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "UnBill creates negotiation letters and financial assistance applications tailored to Michigan hospital systems. Whether your bill is from Trinity Health, a University of Michigan facility, or another Michigan provider, our documents reference applicable policies and Medicare rate benchmarks.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in North Carolina | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "UnBill generates documents specifically tailored to North Carolina hospitals, referencing Atrium Health and Novant Health charity care policies alongside federal 501(r) requirements and Medicare rate comparisons for your specific procedures.",
    ],
  },
  {
    slug: "negotiate-colonoscopy-bill",
    h1: "How to Negotiate a Colonoscopy Bill",
    metaTitle: "How to Negotiate Colonoscopy Costs | UnBill",
    metaDescription:
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "If you have already accumulated a large PT bill, request an itemized statement showing each unit billed per session. Compare the total time represented by the units against your actual appointment duration. UnBill generates negotiation letters that address PT-specific billing practices.",
    ],
  },
  {
    slug: "negotiate-dental-implant-cost",
    h1: "How to Negotiate Dental Implant Costs",
    metaTitle: "How to Negotiate Dental Implant Costs | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "Many dental offices offer 10-20% cash-pay discounts for patients who pay upfront. If you are financing the procedure, compare the dental office's in-house financing terms against a personal loan or medical credit card to find the lowest total cost. UnBill generates negotiation letters tailored to dental billing practices.",
    ],
  },
  {
    slug: "medical-bills-georgia",
    h1: "Fighting Medical Bills in Georgia",
    metaTitle: "Fight Medical Bills in Georgia: Rights & Options | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "If you are fighting a medical bill in Georgia, start by checking whether your hospital is nonprofit and applying for financial assistance. UnBill generates documents that reference Georgia-specific billing practices and the charity care policies of major Georgia hospital systems.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in Arizona: Your Options | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "UnBill generates negotiation letters and financial assistance applications customized for Arizona hospitals, including Banner Health facilities. Our documents reference Medicare rates for the Phoenix and Tucson geographic payment areas and cite applicable federal protections.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in Colorado: Laws & Programs | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "If you are dealing with a medical bill in Colorado, you benefit from both strong state protections and the federal safety net. UnBill creates documents that cite Colorado's Hospital Discounted Care program and UCHealth-specific policies alongside Medicare rate comparisons.",
    ],
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in Massachusetts: Complete Guide | UnBill",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle:
      "Fight Medical Bills in Minnesota: Rights & Resources | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "Whether your bill is from the Mayo Clinic, a regional hospital, or a community clinic, UnBill generates customized negotiation letters that cite Medicare rates specific to Minnesota's geographic payment areas and reference applicable charity care policies.",
    ],
  },
  {
    slug: "medical-bills-louisiana",
    h1: "Fighting Medical Bills in Louisiana",
    metaTitle: "Fight Medical Bills in Louisiana | UnBill",
    metaDescription:
    ...
    paragraphs: [
      ...
      "UnBill generates negotiation letters and financial assistance applications specifically for Louisiana patients. Our documents reference Ochsner Health and other Louisiana hospital system policies, cite Medicare rates for Louisiana geographic areas, and leverage applicable state and federal protections.",
    ],
  },
  {
    ...
    metaTitle:
      "How to Negotiate Knee Replacement Costs | UnBill",
    metaDescription:
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Also verify that you are only charged once for the venipuncture (blood draw, CPT 36415), regardless of how many tests were run from that single draw. UnBill negotiation letters for lab work highlight the dramatic disparity between hospital charges and Medicare rates, which often results in immediate adjustments.",
    ],
  },
]
